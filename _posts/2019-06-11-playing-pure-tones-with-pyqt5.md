...
Its very likely that the original webpage will outlive _The Cracked Bassoon_, but
...
Note that in addition to changing the imported base package, the `QtGui` sub-package is
