...
$$\begin{align}
f=\textrm{P}\left(\Psi > k\mid{}X=0\right)&=\int_{k}^{\infty}\varphi\left(\psi\right) \mathrm{d}\psi=\Phi\left(-k\right)\textrm{,}\tag{2a}\label{eq:2a}
\end{align}$$
...
$$\begin{align}
h&=\textrm{P}\left(Y=1\mid{}X=1\right)=\textrm{P}\left(\Psi> k\mid{}X=1\right)\\
...
$$\begin{align}d^\prime=d=\Phi^{-1}\left(h\right)-\Phi^{-1}\left(f\right)\textrm{.}\tag{3a}\label{eq:3a}\end{align}$$
