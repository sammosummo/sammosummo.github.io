...
\beta_{(\zeta)_c}\sim{}\textrm{Cauchy}\left(0, 5\right)\textrm{,}
$$
...
\sigma_{(\zeta)}\sim{}\textrm{Half-Cauchy}\left(5\right)\textrm{.}
$$
...
I have created a GitHub repository for the code [here](https://github.com/sammosummo/wmm.git). To run with an example data set, download the two scripts somewhere, navigate to that directory and run the following Python snippet:
...
For a real application of the model, please see my recently published paper[<sup>8</sup>].
