...
heritability have been proposed over the years (see [here](http://www.cureffi.org/2013/02/04/how-to-calculate-heritability/)
for a discussion of some of them), but these days, the most common is the method of variance components, which is
implemented in popular genetics software such as GCTA [(Yang et al., 2011)](#Yang2011a) and SOLAR[<sup>2</sup>]. The fundamentals of this method are described below.
