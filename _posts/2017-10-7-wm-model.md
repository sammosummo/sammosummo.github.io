...
$$
\beta_{{\left(\kappa\right)}_{c_{\left(\kappa\right)}}}&\sim{}\mathrm{Normal}\left(0, 10\right)\\
\beta_{{\left(\varsigma\right)}_{c_{\left(\varsigma\right)}}}&\sim{}\mathrm{Normal}\left(0, 10\right)\\
\beta_{{\left(\zeta\right)}_{c_{\left(\zeta\right)}}}&\sim{}\mathrm{Normal}\left(0, 10\right)\textrm{,}
$$

where \(( c_{\left(\kappa\right)} \\), \(( c_{\left(\varsigma\right)} \\), and \(( c_{\left(\zeta\right)} \\) are coefficient indices.
