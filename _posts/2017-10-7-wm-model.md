...
I have created a GitHub repository for the code [here](https://github.com/sammosummo/wmm.git). The script will run an example model on the Rouder et al. data set[<sup>8</sup>] when executed directly.
