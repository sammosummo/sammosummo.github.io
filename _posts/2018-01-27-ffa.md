...
In an arXiv pre-print[<sup>1</sup>], Isabel Gauthier writes,

> The claim also lacks more direct support, as … face-selective activity in FFA does not appear to be heritable.
