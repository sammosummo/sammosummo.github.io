...
Notice that the prior means on the subject-level stochastic variables (e.g., $$\mu_{(\kappa)_i$$) have subscript \\( i \\)s, indicating that they are actually elements within vectors.
