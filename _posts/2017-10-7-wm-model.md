...
$$
\beta_{{(\kappa)}_{c_{(\kappa)}}}\sim{}\mathrm{Normal}\left(0, 10\right)\\
\beta_{{(\varsigma)}_{c_{(\varsigma)}}}\sim{}\mathrm{Normal}\left(0, 10\right)\\
\beta_{{(\zeta)}_{c_{(\zeta)}}}\sim{}\mathrm{Normal}\left(0, 10\right)\textrm{,}
$$
